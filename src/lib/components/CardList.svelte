...
<div class="relative flex flex-col justify-center overflow-hidden">
    <div class="mx-auto max-w-screen-xl px-4 w-full">
      <h2 class="mb-4 font-bold text-xl text-gray-600">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic, consequuntur.</h2>
      <div class="grid w-full grid-cols-1 gap-6">
  
        <div class="border-2 border-indigo-600 relative flex flex-col shadow-md rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 max-w-sm">
